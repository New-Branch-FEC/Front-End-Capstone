  ...
  if(props.title === "RELATED PRODUCTS") {
    ...
    return (
      <div className="card-list">
        ...
        <h1>{props.title}</h1>
        <div>
        {index > 0 && <img className="left-fade-out" src="http://localhost:3000/assets/fadeOut.png"/>}
          ...
          {index + 4 < props.relatedProducts.length && <img className="fade-out" src="http://localhost:3000/assets/fadeOut.png"/>}
      </div>
    )
